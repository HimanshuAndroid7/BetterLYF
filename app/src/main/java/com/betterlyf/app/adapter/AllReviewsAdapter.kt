...
class AllReviewsAdapter: androidx.recyclerview.widget.RecyclerView.Adapter<AllReviewsAdapter.ViewHolder>() {

    private var clickListener: ClickListener? = null

    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): ViewHolder {
        val itemView = LayoutInflater.from(p0.context).inflate(R.layout.view_reviews_full, p0, false)
