...
class SingleCounsellorAdapter: androidx.recyclerview.widget.RecyclerView.Adapter<SingleCounsellorAdapter.ViewHolder>() {

    private var clickListener: ClickListener? = null

    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): ViewHolder {
        val itemView = LayoutInflater.from(p0.context).inflate(R.layout.view_single_counselor, p0, false)
