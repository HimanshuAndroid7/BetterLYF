...
class SlotsAdapter(var mList:Array<String>): androidx.recyclerview.widget.RecyclerView.Adapter<SlotsAdapter.ViewHolder>() {

    private var clickListener: ClickListener? = null

    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): ViewHolder {
        val itemView = LayoutInflater.from(p0.context).inflate(R.layout.view_slots, p0, false)
    ...
    override fun onBindViewHolder(p0: ViewHolder, p1: Int) {
        ...
        p0.itemView.txt_slot.text=mList[p1]
    }
