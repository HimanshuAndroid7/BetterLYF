...
class ProgressAdapter: androidx.recyclerview.widget.RecyclerView.Adapter<ProgressAdapter.ViewHolder>() {

    private var clickListener: ClickListener? = null

    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): ViewHolder {
        val itemView = LayoutInflater.from(p0.context).inflate(R.layout.view_progress, p0, false)
    ...
    inner class ViewHolder(itemView: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(itemView), View.OnClickListener {
        init {
            ...
            itemView.txt_assign.setOnClickListener(this)
        }
